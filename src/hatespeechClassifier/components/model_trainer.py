...
from src.hatespeechClassifier.entity.config_entity import ModelTrainerConfig
from src.hatespeechClassifier.entity.artifact_entity import ModelTrainerArtifacts, DataTransformationArtifacts
...
class ModelTrainer:
    ...
    def spliting_data(self, csv_path):
        try:
            logging.info("Entered into the spliting_data function")
