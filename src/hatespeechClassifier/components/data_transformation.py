...
from src.hatespeechClassifier.entity.config_entity import DataTransformationConfig
from src.hatespeechClassifier.entity.artifact_entity import DataIngestionArtifacts, DataTransformationArtifacts
...
class DataTransformation:
    ...
    def imbalance_data_cleaning(self):
        try:
            logging.info("Entered into the imbalance data cleaning function")
    ...
    def raw_data_cleaning(self):
        try:
            logging.info("Entered into the raw data cleaning function")
            ...
            # Let's change the name of 'class' to label
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifacts:
        try:
            ...
            logging.info("returning the data transformation artifact")
